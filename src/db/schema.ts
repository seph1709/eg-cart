...
export const geoJsonTable = pgTable("geojson", {
  id: text("id").primaryKey(),
...
export type InsertgeoJsonTable = typeof geoJsonTable.$inferInsert;
export type SelectgeoJsonTable = typeof geoJsonTable.$inferSelect;
